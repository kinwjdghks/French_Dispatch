...
const Objects = ({onHover}) => {
  const objectList = [
    ...
    { name: "로벅 라이트", subname: "글 쓰는 사람, 외국인", content: "고향과 다른 시간이 흐르는 곳에서 시차 뒤에 남겨진 기억은 지워지지 않습니다.\n종이 위에 찍힌 철자처럼요.", img: Jeff,id:"Jeff" },
    ...
    { name: "제피렐리", subname: "혜성", content: "그는 혜성이 맞습니다. 좀 일찍 졌을 뿐이죠. \n그리고 동경하는 자들의 티셔츠 속에서 영원히 질 것입니다.", img: Timo,id:"Timo" },
    ...
    {name: "달러", subname:"예술의 연료",content:"아서는 마지막 1달러까지 아끼려 했습니다.\n물론 그의 필진들이 다 써버렸지만요.",img:dollar,id:"dollar"},
    ...
    {name: "담배", subname:"감옥 화폐",content:"<벌거벗은 시몬, J동 취미실>의 가치는 25만 프랑이었습니다.\n혹은 담배 75개비거나요.",img:tobacco,id:"tobacco"},
    {name: "칠면조", subname:"아서가 원했던 것",content:"“오, 안 돼. 그게 뭐야? 칠면조를 그리라니까!”",img:turkey,id:"turkey"},
    {name: "테레빈유", subname:"예술적인 기름",content:"누군가에게는 예술의 재료가 될 수도, 누군가에게는 향수가 될 수도 있습니다. \n아, 둘이 똑같은 게 될 수도 있겠네요.",img:turpentine,id:"turpentine"},
    {name: "타자기", subname:"시작과 끝",content:"언제나 그랬듯, 모든 것은 타자기로부터 시작 되었죠.",img:typewriter,id:"typewriter"},
    {name: "레코드판", subname:"동그랗고 납작한 낭만",content:"제피렐리와 줄리엣이 카페 <<상 블레그>>에서 들은 노래는 \nJarvis Cocker의 <Aline>입니다.",img:vinyl,id:"vinyl"},
    {name: "프렌치 디스패치", subname:"앙뉘의 잡지사",content:"<프렌치 디스패치>는 <더 뉴요커>를 바탕으로 만들어졌습니다.",img:logo,id:"logo"}
  ]
